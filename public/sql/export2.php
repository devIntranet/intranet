...
<?php
	...
	$text_body = "Wygenerowany plik w załączniku o nazwie BLB".$rok_krotki.$miesiac.$dzien."01".".DRR"."<br>"."Data i czas wygenerowania pliku: ".$data." ".$czas.
	...
	$mail->AddAddress("sebastianj@rpwiktychy.local","Eksport SWRK");
